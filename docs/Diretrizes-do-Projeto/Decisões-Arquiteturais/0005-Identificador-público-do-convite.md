...
- Cada caractere de base32 carrega 5 bits, então 128 bits ocupam 26 caracteres.
...
- Token de 26 caracteres não cabe em QR de baixa densidade tão bem quanto os 7 caracteres que um concorrente escolheu de propósito para permitir digitação manual na portaria. Como check-in por QR está fora do MVP, o custo não incide agora.
...
- **UUIDv4: descartado por ergonomia, não por segurança.** UUIDv4 tem 122 bits de fonte criptográfica contra os 128 daqui, e essa diferença não tem efeito prático. O motivo do descarte é a forma: 36 caracteres com hífens contra 26, e aparência de identificador interno de banco em vez de link de convite.
