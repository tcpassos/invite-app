...
App web para criar convites virtuais personalizáveis, compartilhar por link e cuidar da lista de presença (RSVP) e das observações alimentares dos convidados, tudo em um só sistema.
...
- [Guia de Estilo](Diretrizes-do-Projeto/Guia-de-Estilo.md)
- [Instruções de Implementação](Diretrizes-do-Projeto/Instruções-de-Implementação.md)
